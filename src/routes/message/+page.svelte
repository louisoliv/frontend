...
<section class="flex min-h-screen bg-gray-100">
    <section class="relative flex min-h-screen w-[280px]">
        <section class="group absolute left-0 flex flex-col bg-gray-800 min-h-[110vh] w-full">
            ...
            {#each albums as album, albumIndex (albumIndex)}
                ...
                <button class="flex items-center hover:bg-blue-500 rounded-lg ">
                    ...
                    <p class="group-hover:block text-white">{user.name}</p>
                </button>
                {/if}
                {/each}
                {/if}
    ...
    <section class="flex min-h-screen w-full">
        <section class="flex flex-col min-h-screen w-full">
            <div class="flex flex-row justify-between m-3 p-2 h-[8vh]">
                <div class="flex items-center align-middle font-bold text-2xl text-blue-500">UserName</div>
                <div class="flex items-center align-middle">
                    <ul class="flex flex-row items-center w-[12vw] h-[7vh] justify-center">
                        <li class="mr-2">
                            <span class="bg-yellow-400 rounded-full p-6 w-[128px] m-1">O</span>
                        </li>
                        <li class="ml-2"> 
